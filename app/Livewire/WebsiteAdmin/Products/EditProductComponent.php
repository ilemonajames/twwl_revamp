...
class EditProductComponent extends Component
{
    ...
    public function mount($id){
        $this->selProduct = $product = Product::find($id);
    ...
    public function updateProduct($formData){
        ...
        if($this->photo){
            ...
            $this->selProduct->update(['photo' => $imageName]);
        }


        $this->selProduct->update([
        ...
        $this->reset();
        $this->dispatch('feedback', feedback: "Product created Updated");
    ...
    {
        return view('livewire.website-admin.products.edit-product-component')->layout('livewire.website-admin.layouts.app');
    }
}
