<div>
    @include('livewire.website-admin.programs.modals.view-program-modal')
    <x-slot name="title">Program Fees</x-slot>
    ...
    <div class="page-content" >
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Program Fees</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Program Fees</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12" >
                <div class="card">
                    <div class="card-body">
                        <x-search-bar wire:model.live="searchTerm" placeholder="Search by program title or service title" />
                        <x-spin-loader />
                        <div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown float-end"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        {{-- <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewprogramModal" wire:click="setprogram({{ $fee }})" href="#">View</a> --}}
                                                        <a class="dropdown-item" href="{{ route('fees.edit',$fee->id)}}">Edit</a>
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $fee->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
