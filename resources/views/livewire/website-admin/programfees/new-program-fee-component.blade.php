<div>
    <x-slot name="title">Program Fees Setup</x-slot>
    ...
    <div class="page-content">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Add Program Fees</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form name="new-event" id="new-event" wire:submit.prevent="newFees" enctype="multipart/form-data">
                            <div>
                                <div class="mb-3">
