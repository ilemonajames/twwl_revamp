<div>
    ...
    <x-slot name="title">program Records</x-slot>
    ...
    <div class="page-content" >
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Our Programs</h4>
        ...
        <div class="row">
            <div class="col-lg-12" >
                <div class="card">
                    <div class="card-body">
                        <x-search-bar wire:model.live="searchTerm" placeholder="Search by program title or description" />
                        <x-spin-loader />
                        <div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($programs as $program)
                                        <tr>
                                            ...
                                            <td  class="desktopView">{!! Str::limit(strip_tags($program->program_description),150) !!}</td>
                                            <td>
                                                ...
                                                <div class="dropdown float-end"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewprogramModal" wire:click="setprogram({{ $program }})" href="#">View</a>
                                                        <a class="dropdown-item" href="{{ route('programs.edit',$program->id)}}">Edit</a>
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $program->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
