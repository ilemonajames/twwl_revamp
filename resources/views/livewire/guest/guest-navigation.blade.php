<div class="de-flex-col">
    ...
    <div class="menu_side_area">
        ...
        <div class="h-phone sm-hide">
            ...
            <a  href="{{ route('cart')}}"><i class="id-color text-grey bg-hover-2 text-hover-white fa fa-cart-plus mt-4" tooltip="Add to cart" aria-hidden="true"></i></a>
            <div class="mt-3" id="cartquantity">{{ Cart::instance('cart')->count() }}</div>
